  ...
  select {
    ...
    <div class="navbar">
            ...
            <div class="icon">
             ...
             <img src="images/IGP.png" width="200px" height="200px"></img>
       
             <h2>Leyte Normal University</h2>
            <label class="jo">Job NO#:</label>
            <input type="text" class="form-control2" placeholder="JO#">
         
</br>
            <h1>PRINTING JOB ORDER FORM</h1>
            <input type="text" class="form-control1" placeholder=" MM//DD//YY" readonly>
            <label class="jo1">Date:</label>
           </div>
        </div>
    <div class="table">
        <table class="table table-bordered border-secondary" style="width:90%">
                    <thead class="table-borded">
                     <tr >
                        <td colspan="5" >
                            Customer Name</td>
                        </tr>
                        ...
                        <td colspan="5">
                            Mode of Payment:  
                           &nbsp; <select class="mode1" style="width:70%" >
                    ...
                    <option value=" PPMP">Project Procurement Management Plan(PPMP)</option>
                            ...
                            <tr ><td style="text-align: center;">Qty</td>
                              ...
                              <select type="number" name="qty" id="selectqty" style="text-align: center;">
                        ...
                        <tr rowspan="2"><td colspan="5" style="height: 40%">
...
<label style="font-size:15px;">
                           ...
                           Softbind </label>
                            ...
                            &nbsp;&nbsp;&nbsp;<input type="text" style="border-top:none; width: 172px; border-color= black; border-right:none; border-left:none;">
</br>   <center>
...
<th colspan="5" style="border: none; padding-top:-10px;">
                      ...
                      <input type="text" style="border-top:none; width: 252px; border-color= black; border-right:none; border-left:none;">
                      &nbsp; 
                                
<label style="font-size:13px;">
                          
                        Prepared By: </label>
                             <input type="text" style="border-top:none; width: 166px; border-color= black; border-right:none; border-left:none;">
...
<div class="form3" >
               ...
               <img src="images/IGP1.png" class="img" width="250px" height="110px" style="margin-top:-520px; margin-left:-34px;" >
               <button class="btnn2"><i class="fa-solid fa-folder-plus"  style="border:black; color:black; margin-left:-18px"></i> &nbsp;&nbsp;<a href="#">New Job Order</a></button>
                ...
                <button class="btnn4"><i class="fa-solid fa-house" style="border:black; color:black; margin-left:-18px"></i>&nbsp;&nbsp;</i><a href="#">Home</a></button>
